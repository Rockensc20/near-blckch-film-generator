...
function generateNewFilmCombination() {
  // Define possible values for size, format, and ISO
  const sizes = ["135", "120"];
  ...
  const randomIso = isoValues[Math.floor(Math.random() * isoValues.length)];
...
let FilmGeneratorNear = (_dec = NearBindgen({}), _dec2 = view(), _dec3 = call({
...
}), _dec4 = call({}), _dec(_class = (_class2 = class FilmGeneratorNear {
  film_combinations = new Vector("v-uid");

  // ### The Film Combination Generator###

  // Returns the last 10 saved film combinations.
  get_film_combinations({
    from_index = 0,
    limit = 10
  }) {
    return this.film_combinations.toArray().slice(from_index, from_index + limit);
  }
  ...
  // Returns a freshly generated film combination
  get_film_combination() {
    const new_combination = generateNewFilmCombination();
    return new_combination;
  }
}, (_applyDecoratedDescriptor(_class2.prototype, "get_film_combinations", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "get_film_combinations"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "save_film_combination", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "save_film_combination"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_film_combination", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "get_film_combination"), _class2.prototype)), _class2)) || _class);
...
export { get_film_combination, get_film_combinations, save_film_combination };
